...
from aniauth.forms import RegistrationForm, ActivationForm
...
@csrf_protect
@never_cache
def register(request, template_name='account/register.djhtml',
...
def activate(request, template_name='account/activate.djhtml',
        redirect_field_name=REDIRECT_FIELD_NAME,
...
@login_required
def profile(request): return render(request, "account/base.djhtml")